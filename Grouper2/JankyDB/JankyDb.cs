...

{
    ...
    public static class JankyDb
    {
        ...
        new RegKey(){
            ...
            FriendlyDesc = null,
            IntLevel = 3,
            Key =  @"Microsoft\\Windows\\CurrentVersion\\Policies\\System\\Audit\\ProcessCreationIncludeCmdLine_Enabled",
        },
        new RegKey(){
        ...
        new RegKey(){
            ...
            FriendlyDesc = null,
            IntLevel = 5,
            Key =  @"CurrentControlSet\\Control\\Print\\Providers\\LanMan Print Services\\Servers\\AddPrinterDrivers",
        },
        new RegKey(){
            MsDesc =  null,
            FriendlyDesc = null,
